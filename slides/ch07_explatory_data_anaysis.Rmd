...
## モデルと残差
### 疑問
`diamonds`でcutが良いほうがpriceが高い、というパターンが観察された。なぜ？

### 仮説
`carat`という中間変数が作用している。
すなわち`carat`が大きい方が`price`が高くなるが、`cut`が悪い方が`carat`が大きく、またその逆も成立するのでは？
